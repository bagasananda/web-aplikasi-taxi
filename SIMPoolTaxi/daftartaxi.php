...
<TR>
                                ...
                                do {
                                    ...
                                    echo '<td>' . $data['HargaDasarPool'] . '</td>';
                                    echo '<td>' . $data['StatusTaxi'] . '</td>';


                                    echo '<td><a href="editcari.php?id=' . $data['Noplat'] . '" class="btn btn-warning btn-md">Edit</a> &nbsp; <a href="hapustaxi.php?id=' . $data['Noplat'] . '" onclick="return confirm(\'Apakah Anda Yakin Ingin Menghapus Data Ini?\')" class="btn btn-danger btn-md">Hapus</a></td>';
